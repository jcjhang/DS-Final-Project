...
int policy_1(int revenue_part1){
    my_data read_data;
        ...
        while(!ifs.eof()){
            ...
            if(action == "rent"){
                ...
                if(my_heap->isEmpty()){
                    cout << "-------------------------- reject --------------------------" << endl;
                    ofs << "reject" << endl;
                    my_Algo my_Algo(my_bike_heap);
                    my_Algo.change_bike(station_id, rent_list[rent_num][1]);
                    if(my_Algo.change_bike_type == 10000){   // other types at that station are also empty
                        ...
                        if(my_Algo.change_bike_type == 0){
                            cout << "discount electric" << endl;
                            ofs << "discount electric" << endl;
                        }
                        if(my_Algo.change_bike_type == 1){
                            cout << "discount lady" << endl;
                            ofs << "discount lady" << endl;
                        }
                        if(my_Algo.change_bike_type == 2){
                            cout << "discount road" << endl;
                            ofs << "discount road" << endl;
                        }
                        rent_list[rent_num][1] = my_Algo.change_bike_type;  // update the rent list
                        rent_list[rent_num][4] = my_Algo.change_bike_id;
    ...
    if (!ofs.is_open()) {
        ...
        int improvement = revenue - revenue_part1;
...
{   // part 2 scope
    ...
    if (!ofs1.is_open()) {
        ...
        int improvement = revenue - revenue_1;
        cout << "improvement: " << improvement << endl;
    }
}   // end of part 2 scope  
}
